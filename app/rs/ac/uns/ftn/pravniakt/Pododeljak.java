 ...
 *       &lt;sequence>
 *         &lt;element name="rednoSlovo" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
public class Pododeljak {
    ...
    @XmlElementRef(name = "rednoSlovo", namespace = "http://www.ftn.uns.ac.rs/pravniAkt", type = JAXBElement.class, required = false)
    protected JAXBElement<String> rednoSlovo;
     ...
     *     
     */
    public JAXBElement<String> getRednoSlovo() {
        return rednoSlovo;
    }
     ...
     *     
     */
    public void setRednoSlovo(JAXBElement<String> value) {
